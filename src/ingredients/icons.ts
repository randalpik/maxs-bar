...
export function icon(shape: string, color: string): string {
  ...
  switch (shape) {
    ...
    case 'sack': inner = `<path d="M13 5.5 h6 L19.5 8.5 H12.5 Z" fill="${color}" ${w}/><path d="M12.5 8.5 C10 12 8.5 15 8.5 19.5 C8.5 24.5 11.5 27 16 27 C20.5 27 23.5 24.5 23.5 19.5 C23.5 15 22 12 19.5 8.5 Z" fill="${color}" ${w}/>`; break;
    ...
    case 'cheese': inner = `<path d="M5.5 20.5 L26.5 12.5 V21.5 a1.5 1.5 0 0 1 -1.5 1.5 H7 a1.5 1.5 0 0 1 -1.5 -1.5 Z" fill="${color}" ${w}/><circle cx="13" cy="19.5" r="1.3" fill="none" stroke="${S}" stroke-width=".9" opacity=".5"/><circle cx="19" cy="17.5" r="1" fill="none" stroke="${S}" stroke-width=".9" opacity=".5"/>`; break;
    case 'patty': inner = `<rect x="6" y="12" width="20" height="8" rx="4" fill="${color}" ${w}/><circle cx="11.5" cy="16" r=".9" fill="${S}" opacity=".4"/><circle cx="16" cy="16" r=".9" fill="${S}" opacity=".4"/><circle cx="20.5" cy="16" r=".9" fill="${S}" opacity=".4"/>`; break;
    case 'scoop': inner = `<circle cx="16" cy="10.5" r="6.5" fill="${color}" ${w}/><path d="M10.5 14 L16 27 L21.5 14 Z" fill="${color}" ${w}/>`; break;
    ...
    case 'avocado': inner = `<path d="M16 4.5 C12.5 4.5 11 8.5 10 12.5 C8.5 18 10.5 27 16 27 C21.5 27 23.5 18 22 12.5 C21 8.5 19.5 4.5 16 4.5 Z" fill="${color}" ${w}/><circle cx="16" cy="19" r="3.8" fill="none" stroke="${S}" stroke-width="1.2" opacity=".55"/>`; break;
